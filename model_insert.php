...
$servername = "50.62.209.87";
$username = "sajith";
$password = "S7487091884!";
$dbname = "spotligh_data";
...
$model_country            = $_POST['model_country'];

$model_state              = $_POST['model_state'];
...
$model_video1    = $_POST['video1'];

$model_video2    = $_POST['video2'];

$model_video3    = $_POST['video3'];

$model_video4    = $_POST['video4'];

$model_audio1    = $_POST['audio1'];

$model_audio2    = $_POST['audio2'];

$model_audio3    = $_POST['audio3'];

$model_audio4    = $_POST['audio4'];

$q = mysqli_query($conn,'SELECT MAX(model_code) as model_code from `user_reg` ');
...
$model_facebook  = $_POST['model_facebook'];

$model_twitter   = $_POST['model_twitter'];

$model_google    = $_POST['model_google'];

$model_instagram = $_POST['model_instagram'];

$model_pinterest = $_POST['model_pinterest'];

$model_linkedin  = $_POST['model_linkedin'];

$model_skype     = $_POST['model_skype'];

$model_youtube   = $_POST['model_youtube'];

$select_query=mysqli_query($conn,"SELECT * from user_reg where user_email='$user_email' ");
...
$query = $conn->prepare("Insert into `user_reg` (`user_category`,`user_sub_category`,`user_password`,`user_type`, `user_status`, `user_name`, `user_number`, `whtsapp_number`, `user_email`, `user_dob`, `model_gender`, `maritial_status`, `model_age`, `model_country`, `model_state`, `model_biography`, `user_address`, `model_height`, `model_heels`, `model_weight`, `model_waist`, `model_hips`, `model_bust`, `model_body_type`, `model_hair_length`, `model_hair_color`, `moded_skin_color`, `model_eye_color`, `model_skin_tone`, `model_cup_size`, `model_tattos`, `model_compensation`, `model_nude_shoots`, `model_portfolio`, `model_package`, `model_modeling`, `model_actor_actress`, `model_artist_perfomer`, `model_completed_project`, `model_current_project`, `model_image1`, `model_image2`, `model_image3`, `model_image4`, `model_image5`, `model_image6`, `model_image7`, `model_image8`, `model_video1`, `model_video2`, `model_video3`, `model_video4`, `model_audio1`, `model_audio2`, `model_audio3`, `model_audio4`, `model_code`, `model_facebook`, `model_twitter`, `model_google`, `model_instagram`, `model_pinterest`, `model_linkedin`, `model_skype`, `model_youtube`,`refer`,`refer_name` )VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");

$query->bind_param('ssssssssssssissssssssssssssssssssssssssssssssssssssssssssssssssssss',
  $user_category,  $user_sub_category,  $password,  $user_type,  $user_status,  $user_name,  
  $user_number,  $whtsapp_number,  $user_email,  $user_dob,  $model_gender,  $maritial_status, 
   $model_age,  $model_country,  $model_state,  $model_biography,  $user_address,  $model_height, 
    $model_heels,  $model_weight,  $model_waist,  $model_hips,  $model_bust,  $model_body_type,  
    $model_hair_length,  $model_hair_color,  $moded_skin_color,  $model_eye_color,  $model_skin_tone,  $model_cup_size,  $model_tattos,  $model_compensation,  $model_nude_shoots,  $model_portfolio,  $model_package,  $model_modeling,  $model_actor_actress,  $model_artist_perfomer, 
     $model_completed_projects,  $model_current_project,  $profile_name1,  $profile_name2, 
      $profile_name3,  $profile_name4,  $profile_name5,  $profile_name6,  $profile_name7,  
      $profile_name8,  $model_video1,  $model_video2,  $model_video3,  $model_video4,  $model_audio1,  $model_audio2,  $model_audio3,  $model_audio4,  $model_code,  $model_facebook, 
       $model_twitter,  $model_google,  $model_instagram,  $model_pinterest,  $model_linkedin, 
        $model_skype,  $model_youtube ,$refer,$refer_name); 
