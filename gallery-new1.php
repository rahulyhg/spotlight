...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="isotope_container isotope row masonry-layout" data-filters=".isotope_filters">
								...
								<div class="isotope-item col-lg-2 col-md-4 col-sm-6 webdesign photography development">
									<div class="vertical-item gallery-item content-absolute text-center cs">
										<div class="item-media">
								...
								<div class="isotope-item col-lg-2 col-md-4 col-sm-6 webdesign photography">
									<div class="vertical-item gallery-item content-absolute text-center cs">
										<div class="item-media">
			...
			<section class="ds section_padding_bottom_80">
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<a href="#" class="theme_button inverse wide_button margin_0">Load More</a>
						</div>
					</div>
				</div>
			</section>
