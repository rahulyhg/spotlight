			...
			<section class="page_topline ds ms gorizontal_padding table_section">
				...
				<div class="container-fluid with_border">
					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-3 col-lg-2 text-xs-center text-right text-lg-left">
							...
							<ul class="inline-dropdown inline-block">
								...
								<li class="dropdown cart-dropdown">
									...
									<a class="topline-button" id="cart" data-target="#" href="cart.php" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false">
									...
									<div class="dropdown-menu" aria-labelledby="cart">
										...
										<span class="grey">Recently added Model(s)</span>
										...
										<div class="widget widget_shopping_cart">
										 ...
										 $query=mysqli_query($connect,"SELECT * FROM user_reg WHERE user_id='$id' ");
													   if(!$query){
						...
						<a href="model-single.php?id=<?php echo $row['user_id']?>"><?php echo $row['user_name']?></a>
					...
					<a href="cart.php?delete=<?php echo $row['user_id']?>" class="remove" title="Remove this item">
												...
												<p class="buttons">
													...
													<a href="#" class="theme_button inverse">Checkout</a>
								...
								<li class="dropdown login-dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="login">
										...
										<a href="register_account.php" class="theme_button color1">
...
?>
	...
	<div class="vertical-item maincarousel-item content-absolute cs">
							...
							<div class="item-media">
								...
								<img src="admin/<?php echo $get_banner['b_img'];?>" style="height:460.867px;width:307.25px;"  alt="">

								<div class="media-links" style="height:460.867px;width:307.25px;">
...
<section class="ds page_testimonials">
...
$per_page=8;
 $last_page=ceil($rows/$per_page);
   ...
   $middleNumbers='';
                  ...
                  $gallery =  mysqli_query($connect,"select * from `gallerypic` LIMIT ".($page-1)*$per_page.",".$per_page." ");
						...
						<div class="isotope-item col-lg-3 col-md-4 col-sm-6 fashion">
							...
							<div class="vertical-item content-absolute">
								...
								<div class="item-media">
									...
									<img src="admin/<?php echo $img_tejas ?>" style="width:284.75px;height:427.117px;" alt="">

									<div class="media-links" style="width:284.75px;height:427.117px;">
...
$model_hair_color = $get_user['model_hair_color'];

$model_heels = $get_user['model_heels'];
...
$model_eyes = $get_user['model_eye_color'];
								...
								<div>
									...
									<div class="vertical-item maincarousel-item content-absolute">
										...
										<div class="item-media">
											...
											<img src="admin/model/<?php echo $mode_image1 ?>" alt="" style="width:409.667px;height:409.667px;">

											<div class="media-links" style="width:409.667px;height:409.667px;">
										...
										<div class="item-content grey gradient_bg_vert before_cover">
											...
											<div class="model-parameters vertical-layout">
												...
												<h2>
													...
													<a href="model-single.php?id=<?php echo $id ?>"><?php echo $user_name ?>
												...
												<div>
													...
													<span><?php echo $model_height ?></span>
												...
												<div>
													...
													<span><?php echo $model_waist ?></span>
												...
												<div>
													...
													<span><?php echo $model_hair_color ?></span>
											...
											<div class="links-wrap topmargin_40">
												...
												<a class="p-link" title="" href="model-single.php?id=<?php echo $id ?>"></a>
...
?>
					...
					<div class="row topmargin_50">
						...
						<div class="col-xs-12 text-center margin_0" style="padding-top:50px;">
			...
			<section class="ds ms section_padding_top_80 columns_padding_0" style="padding:80px;">
