				...
				<div class="container">
					...
					<div class="row display_table_md">
						<div class="col-md-4 display_table_cell_md">
							...
							<div class="price-table with_background">
								<div class="plan-name text-uppercase darkgrey_bg_color">
									<h3>Basic</h3>
								</div>
								<div class="plan-price cs">
									<span>$</span>
									<span>120</span>
									<p>per session</p>
								</div>
								...
								<div class="call-to-action">
									<a href="#" class="theme_button inverse">sign up</a>
								</div>
							</div>
						...
						<div class="col-md-4 display_table_cell_md">
							...
							<div class="price-table with_background central">
								<div class="plan-name text-uppercase darkgrey_bg_color">
									<h3>Unlimited</h3>
								</div>
								<div class="plan-price cs">
								...
								<div class="features-list">
									<ul>
										<li>Sea takimata sanctus</li>
										<li>Lorem ipsum</li>
										<li>Dolor sit amet ipsum</li>
						...
						<div class="col-md-4 display_table_cell_md">
							...
							<div class="price-table with_background">
								...
								<div class="features-list">
									<ul>
										<li>Aliquyam erat, sed diam</li>
										<li>At vero eoset</li>
										<li>Accusam et justo</li>
										<li>Duo dolores</li>
