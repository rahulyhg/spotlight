...
$product.='          
       <tr style="border:1px solid;">
        ...
        <td style="border:1px solid;">'.$m1.'</td>
        <td style="border:1px solid;"><a  href="'.$m2.'"><img src="'.$m2.'" style="height:50px;width:50px;"></a></td>
        <td style="border:1px solid;">'.$shoot_type.'</td>
       </tr>
