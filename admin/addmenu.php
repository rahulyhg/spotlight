    ...
    <div id="wrapper">
      ...
      <?php include("common/menu.php");?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><center>Add Menu</center></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                          ...
                          <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                 <form role="form" action="viewmenu.php" method="post">
                                         <div class="form-group">
                                            <label class="control-label" for="Enter Menu Name">Enter Menu Name</label>
                                            <input type="text" class="form-control" id="name" name="menu_name" required autofocus>
                                        </div>
